            ...
            <div class="container py-2">
                <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                    ...
                    <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                        <li><a href="/" class="links border-bottom nav-link link-secondary me-3">Home</a></li>
                        <li><a href="/" class="links nav-link link-secondary me-3">Hombre</a></li>
                        <li><a href="/" class="links nav-link link-secondary me-3">Mujer</a></li>
                    </ul>
                    <div class="col-md-3 text-end">
                        <button type="button" class="btn btn-outline-light me-3">Login</button>
                        <button type="button" class="btn btn-light  me-3">Sign-up</button>
