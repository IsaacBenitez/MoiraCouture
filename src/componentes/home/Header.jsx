            ...
            <div className="container py-2">
                <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                    ...
                    <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li>
                            <div className="links nav-link link-secondary me-3"><Link to={"/Hombre"} className="links nav-link link-secondary">
                                Hombre
                            </Link>
                            </div>
                        </li>
                        ...
                        <li>
                            <div className="links nav-link link-secondary me-3"><Link to={"/Mujer"} className="links nav-link link-secondary">
                                Mujer
                            </Link>
                            </div>
                        </li>
